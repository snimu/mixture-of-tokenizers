...
# Machine 1
uv run data_creation.py --from-batch 0 --to-batch 200 --skip-fw-val-batches --tokenize --start-upload-loop
...
# Machine 2
uv run data_creation.py --from-batch 2000 --to-batch 2200 --skip-fm-val-batches --skip-fw-val-batches --tokenize --start-upload-loop
...
# Machine 3
uv run data_creation.py --from-batch 4000 --to-batch 4200 --skip-fm-val-batches --skip-fw-val-batches --tokenize --start-upload-loop
...
# Machine 4
uv run data_creation.py --from-batch 6000 --to-batch 6200 --skip-fm-val-batches --skip-fw-val-batches --tokenize --start-upload-loop
...
# Machine 5
uv run data_creation.py --from-batch 8000 --to-batch 8200 --skip-fm-val-batches --skip-fw-val-batches --tokenize --start-upload-loop
...
# Machine 6
uv run data_creation.py --from-batch 9000 --skip-fm-val-batches --tokenize --start-upload-loop
