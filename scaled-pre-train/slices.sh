...
# Machine 1
uv run data_creation.py --from-batch 0 --to-batch 2000 --skip-fw-val-batches --tokenize
...
# Machine 2
uv run data_creation.py --from-batch 20000 --to-batch 22000 --skip-fm-val-batches --skip-fw-val-batches --tokenize
...
# Machine 3
uv run data_creation.py --from-batch 40000 --to-batch 42000 --skip-fm-val-batches --skip-fw-val-batches --tokenize
...
# Machine 4
uv run data_creation.py --from-batch 60000 --to-batch 62000 --skip-fm-val-batches --skip-fw-val-batches --tokenize
...
# Machine 5
uv run data_creation.py --from-batch 80000 --to-batch 82000 --skip-fm-val-batches --skip-fw-val-batches --tokenize
...
# Machine 6
uv run data_creation.py --from-batch 90000 --skip-fm-val-batches
