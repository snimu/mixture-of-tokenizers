...
if master_process:
    ...
    os.makedirs("../logs/4_bytes-in_toks-valemb", exist_ok=True)
    logfile = f"../logs/4_bytes-in_toks-valemb/{run_id_full}.txt"
    print(logfile)
...
embed_params = [*model.embed_bytes.parameters(), *model.value_embeds.parameters()]
