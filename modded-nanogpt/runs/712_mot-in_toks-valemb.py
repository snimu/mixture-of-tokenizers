...
- Increased MLP hidden dim to make up for the parameters saved in the token embedding layer
"""
...
if master_process:
    ...
    os.makedirs("../logs/712_mot-in_toks-valemb", exist_ok=True)
    logfile = f"../logs/712_mot-in_toks-valemb/{run_id_full}.txt"
    print(logfile)
