...
This file serves as a comparison to the unaltered train_gpt_medium.py file, baselining two things:

1. The correctness of the MoT dataloader (at least regarding the tokens)
2. The slowdown caused by the MoT dataloader
"""
...
if master_process:
    ...
    os.makedirs("../logs/1_toks-in_toks-valemb", exist_ok=True)
    logfile = f"../logs/1_toks-in_toks-valemb/{run_id_full}.txt"
    print(logfile)
