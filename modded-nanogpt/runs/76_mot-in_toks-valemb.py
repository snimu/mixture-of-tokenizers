"""
Variation of 75_mot-in_toks-valemb.py

Changes:

- Changed lr-schedule from SD to WD (but not WSD)
"""
...
if master_process:
    ...
    os.makedirs("../logs/76_mot-in_toks-valemb", exist_ok=True)
    logfile = f"../logs/76_mot-in_toks-valemb/{run_id_full}.txt"
    print(logfile)
...
warmup_frac = 1 - args.cooldown_frac
def get_lr(step: int):
