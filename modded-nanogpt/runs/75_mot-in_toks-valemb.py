"""
Variation of 72_mot-in_toks-valemb.py

Changes:

- Reduced the token dim to 896
"""
...
if master_process:
    ...
    os.makedirs("../logs/75_mot-in_toks-valemb", exist_ok=True)
    logfile = f"../logs/75_mot-in_toks-valemb/{run_id_full}.txt"
    print(logfile)
