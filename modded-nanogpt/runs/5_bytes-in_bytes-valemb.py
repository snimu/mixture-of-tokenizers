...
- Bytes at the inputs and value embeddings
"""
...
if master_process:
    ...
    os.makedirs("../logs/5_bytes-in_bytes-valemb", exist_ok=True)
    logfile = f"../logs/5_bytes-in_bytes-valemb/{run_id_full}.txt"
    print(logfile)
...
embed_params = [*model.embed_bytes.parameters(), *model.value_embeds_bytes.parameters()]
