...
if master_process:
    ...
    os.makedirs("../logs/3_toks-in_mot-valemb", exist_ok=True)
    logfile = f"../logs/3_toks-in_mot-valemb/{run_id_full}.txt"
    print(logfile)
...
embed_params = [*model.embed_tokens.parameters(), *model.value_embeds_toks.parameters(), *model.value_embeds_bytes.parameters()]
