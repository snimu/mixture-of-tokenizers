"""
Changed from 0_train_gpt_medium.py
...
class Hyperparameters:
    ...
    cooldown_frac = 0.95 # fraction of training spent cooling down the learning rate; warmup-frac = 1 - cooldown-frac
    # architecture
    vocab_size = 50257
...
if master_process:
    ...
    os.makedirs("../logs/01_train_gpt_medium", exist_ok=True)
    logfile = f"../logs/01_train_gpt_medium/{run_id_full}.txt"
    print(logfile)
