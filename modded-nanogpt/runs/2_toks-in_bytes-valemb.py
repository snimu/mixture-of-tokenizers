...
if master_process:
    ...
    os.makedirs("../logs/2_toks-in_bytes-valemb", exist_ok=True)
    logfile = f"../logs/2_toks-in_bytes-valemb/{run_id_full}.txt"
    print(logfile)
...
embed_params = [*model.embed_tokens.parameters(), *model.value_embeds_bytes.parameters()]
